// var sipmlapi = import("../plugins/sipml5/SIPml-api.js");
// var sipml = SIPml;
...
['/media/plugins/sipml5/SIPml.js', '/media/plugins/sipml5/src/tinySIP/src/tsip_api.js'].forEach(function (file) {
...
$('.btn-audio-call').click(function(e){
    e.preventDefault();
    $(this).prev('form').toggle();
    $(this).next('div').toggle();
});
$('.acb-call-btn').click(function(e) {
    e.preventDefault();
    $('.audio-call-messages').toggle();
    $('.acb-hang-up-btn').attr('disabled', false);
    $('.acb-hang-up-btn').toggleClass('btn-danger');
    $('.acb-hang-up-btn').toggleClass('btn-secondary');
...
// var SIPml = sipml;
function sipCall(eventType){
SIPml.init(
    function(eventType){
        var stack =  new SIPml.Stack({proxy:'wss://95.67.10.178:5060/ws' ,realm: '95.67.10.178:5060', impi: '602', impu: 'sip:602@95.67.10.178:5060', password: 'PGbKTF0OogLTosh',
