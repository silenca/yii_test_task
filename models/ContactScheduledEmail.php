...
/**
 * This is the model class for table "contact_scheduled_email".
 *
 * @property integer $id
 ...
 */
class ContactScheduledEmail extends \yii\db\ActiveRecord {
    ...
    public static function tableName() {
        return 'contact_scheduled_email';
    }
    ...
    public function add($contact_id, $schedule_date, $action_comment_text) {
        ...
        try {
            ...
            $action = new Action();
            $action_type = ActionType::find()->where(['name' => 'scheduled_email'])->one();
