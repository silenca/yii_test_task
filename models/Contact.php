...
use yii\httpclient\XmlParser;
    ...
    class Contact extends ActiveRecord
    {
        ...
        public const LEAD = 1;//STATUSES
        public const CONTACT = 2;//STATUSES
        public const MEDIUM_API_URL = 'http://91.225.122.210:8080/api/H:1D13C88C20AA6C6/D:WORK/D:1D13C9303C946F9/C:1D45F18F27C737D';
        public const MEDIUM_API_OBJECT = '/O:'; //FOR SINGLE OBJECT
        public const MEDIUM_API_ITEM = '/I:'; //FOR LISTINGS
        private $tags;
        private $sended_crm;
        /**
        ...
        public static function getMediumObjects()
        {
            ...
            if ($response->isOk) {
//                $xml = new XMLparser();
//                $xmlObjects = $xml->parse($response);
//                foreach($xmlObjects['OBJECT'] as $key=>$value) {
